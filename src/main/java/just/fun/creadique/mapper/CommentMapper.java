...
import just.fun.creadique.model.dto.CommentUpdateDto;
...
@Mapper
public interface CommentMapper extends GenericMapper<Comment, CommentDto, CommentEntity, CommentUpdateDto, CommentUpdateEntity>{
}
